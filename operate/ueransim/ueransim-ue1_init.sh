...
# Init script for UERANSIM UE1 with pjsua for e2e VoNR testing.
# Starts nr-ue, waits for IMS bearer, then starts pjsua.

export IP_ADDR=$(awk 'END{print $1}' /etc/hosts)

# Copy and configure UE1 template
...
sed -i 's|UE1_OPC|'$UE1_OPC'|g' /UERANSIM/config/${COMPONENT_NAME}.yaml
...
echo "============================================"
echo "  UERANSIM UE1 + pjsua E2E VoNR Test"
echo "  IMSI:       ${UE1_IMSI}"
echo "  MSISDN:     ${MSISDN}"
